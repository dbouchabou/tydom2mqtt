...
class Sensor:
    ...
    def __init__(self, 
        ...
        self.entity['object_id'] = "{}_{}_{}".format(self.attr['name'],self.attr['device_id'],self.attr['data_name'])
        self.entity['unique_id'] = "{}_{}_{}".format(self.attr['name'],self.attr['device_id'],self.attr['data_name'])
